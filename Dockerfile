...
# PATCH: Agregar import de crypto en @nestjs/schedule para fix el bug
RUN sed -i '/const name = options.name || crypto.randomUUID()/i const crypto = require("crypto");' /app/node_modules/@nestjs/schedule/dist/scheduler.orchestrator.js
